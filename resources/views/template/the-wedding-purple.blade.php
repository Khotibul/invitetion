...
<head>
	...
	<!-- Royal Purple & Lavender Theme Override -->
	<style>
	/* ═══════════════════════════════════════════
	   THE WEDDING — ROYAL PURPLE & LAVENDER EDITION
	   Warna utama : #6b3fa0 (royal purple)
	   Aksen       : #c9a8e0 (lavender)
	   Latar gelap : #3d1f6b
	═══════════════════════════════════════════ */
	...
	.couple-main {
		...
		border: 3px solid #6b3fa0 !important;
		box-shadow: 0 0 0 6px rgba(107,63,160,.15) !important;
	}
	...
	.footer-couple-photo  { width:100px; height:100px; border-radius:50%; object-fit:cover; border:3px solid #6b3fa0; box-shadow:0 4px 15px rgba(0,0,0,.15); }
	.footer-couple-placeholder { width:100px; height:100px; border-radius:50%; background:#f5f0fa; border:3px solid #6b3fa0; display:flex; align-items:center; justify-content:center; color:#6b3fa0; font-size:2.5rem; }
	.footer-couple-sep { font-size:1.8rem; color:#c9a8e0; font-family:'Satisfy',Arial,serif; }

	/* Overlay cover */
	#overlay {
		background: linear-gradient(160deg, #3d1f6b 0%, #6b3fa0 55%, #9b6fc8 100%) !important;
	}
	#overlay .content h1 { color:#f5f0fa !important; letter-spacing:2px; }
	#overlay .content h3 { color:#c9a8e0 !important; }
	#overlay .content p  { color:rgba(245,240,250,.85) !important; }
	#overlay .btn-primary {
		background:transparent !important; border:1px solid #c9a8e0 !important;
		color:#f5f0fa !important; letter-spacing:3px; text-transform:uppercase;
		font-size:.8rem; padding:.7rem 2rem; border-radius:0;
	}
	#overlay .btn-primary:hover { background:#c9a8e0 !important; color:#3d1f6b !important; }

	/* Header */
	#fh5co-header { background:linear-gradient(180deg,#f5f0fa 0%,#e8d8f5 100%) !important; }
	#fh5co-header h2 { color:#6b3fa0 !important; letter-spacing:4px; }
	#fh5co-header h1 { color:#3d1f6b !important; }
	#fh5co-header p[style*="bf9b73"] { color:#6b3fa0 !important; }
	#fh5co-header .btn-primary { background:#6b3fa0 !important; border-color:#6b3fa0 !important; border-radius:0; letter-spacing:2px; }
	#fh5co-header .btn-info    { background:#c9a8e0 !important; border-color:#c9a8e0 !important; color:#3d1f6b !important; }
	#fh5co-header a[style*="bf9b73"] { background:#6b3fa0 !important; }

	/* Countdown */
	.simply-countdown > .simply-section { background:#6b3fa0 !important; border-radius:6px; }
	.simply-countdown > .simply-section .simply-amount { color:#f5f0fa !important; }
	.simply-countdown > .simply-section .simply-word   { color:rgba(245,240,250,.75) !important; }

	/* Couple section */
	#fh5co-couple { background:#f5f0fa !important; }
	#fh5co-couple h2 { color:#6b3fa0 !important; }
	#fh5co-couple h3 { color:#3d1f6b !important; }
	#fh5co-couple .desc-groom h3,
	#fh5co-couple .desc-bride h3 { color:#6b3fa0 !important; }
	#fh5co-couple .desc-groom p span[style*="bf9b73"],
	#fh5co-couple .desc-bride  p span[style*="bf9b73"] { color:#6b3fa0 !important; }
	#fh5co-couple .icon-heart2 { color:#6b3fa0 !important; }
	#fh5co-couple .fh5co-social-icons a { color:#6b3fa0 !important; }

	/* Event section */
	#fh5co-event { background:#3d1f6b !important; }
	#fh5co-event h2, #fh5co-event h3 { color:#f5f0fa !important; }
	#fh5co-event .event-wrap {
		background:rgba(255,255,255,.07) !important;
		border:1px solid rgba(201,168,224,.3) !important;
		border-radius:8px;
	}
	#fh5co-event .event-wrap h3 { color:#c9a8e0 !important; }
	#fh5co-event .event-col span { color:#f5f0fa !important; }
	#fh5co-event .icon-clock, #fh5co-event .icon-calendar { color:#c9a8e0 !important; }
	#fh5co-event .btn-primary { background:#6b3fa0 !important; border-color:#6b3fa0 !important; border-radius:0; }

	/* Gallery */
	#fh5co-gallery { background:#f5f0fa !important; }
	#fh5co-gallery h2 { color:#6b3fa0 !important; }
	#fh5co-gallery h3 { color:#6b3fa0 !important; }

	/* Quote / ayat */
	#fh5co-ayat { background:linear-gradient(135deg,#6b3fa0 0%,#3d1f6b 100%) !important; }
	#fh5co-ayat .ayat-content { color:#f5f0fa !important; font-family:'Merriweather',serif !important; font-style:italic; }

	/* Health protocol */
	#fh5co-health-protocol { background:#f5f0fa !important; }
	#fh5co-health-protocol h2 { color:#6b3fa0 !important; }
	#fh5co-health-protocol h3 { color:#3d1f6b !important; font-size:1rem !important; }
	#fh5co-health-protocol p[style*="bf9b73"] { color:#6b3fa0 !important; }

	/* Wishes */
	#fh5co-testimonial { background:#f5f0fa !important; }
	#fh5co-testimonial h2 { color:#6b3fa0 !important; }
	#fh5co-testimonial span[style*="bf9b73"] { color:#6b3fa0 !important; }
	#fh5co-testimonial .btn-primary { background:#6b3fa0 !important; border-color:#6b3fa0 !important; border-radius:0; }
	#fh5co-testimonial .form-control:focus { border-color:#6b3fa0 !important; box-shadow:0 0 0 .2rem rgba(107,63,160,.15) !important; }

	/* Footer */
	#fh5co-footer { background:#3d1f6b !important; }
	#fh5co-footer h1 { color:#f5f0fa !important; }
	#fh5co-footer h3 { color:#c9a8e0 !important; }
	#fh5co-footer p  { color:rgba(245,240,250,.7) !important; }
	#fh5co-footer small { color:rgba(245,240,250,.5) !important; }
	#fh5co-footer div[style*="rgba(191"] { background:rgba(107,63,160,.15) !important; border-color:rgba(107,63,160,.35) !important; }
	#fh5co-footer a[style*="bf9b73"] { background:#6b3fa0 !important; }
	#fh5co-footer div[style*="bf9b73"] { color:#c9a8e0 !important; }

	/* Floating button */
	.float .control-center .option-btn { background-color:#6b3fa0 !important; }
