...
<head>
	...
	<!-- Dusty Rose & Blush Pink Theme Override -->
	<style>
	/* ═══════════════════════════════════════════
	   THE WEDDING — DUSTY ROSE & BLUSH PINK EDITION
	   Warna utama : #d4a5a5 (dusty rose)
	   Aksen       : #f7d7d7 (blush pink)
	   Latar gelap : #8b6b6b
	═══════════════════════════════════════════ */
	...
	.couple-main {
		...
		border: 3px solid #d4a5a5 !important;
		box-shadow: 0 0 0 6px rgba(212,165,165,.15) !important;
	}
	...
	.footer-couple-photo  { width:100px; height:100px; border-radius:50%; object-fit:cover; border:3px solid #d4a5a5; box-shadow:0 4px 15px rgba(0,0,0,.15); }
	.footer-couple-placeholder { width:100px; height:100px; border-radius:50%; background:#fdf5f5; border:3px solid #d4a5a5; display:flex; align-items:center; justify-content:center; color:#d4a5a5; font-size:2.5rem; }
	.footer-couple-sep { font-size:1.8rem; color:#f7d7d7; font-family:'Satisfy',Arial,serif; }

	/* Overlay cover */
	#overlay {
		background: linear-gradient(160deg, #8b6b6b 0%, #d4a5a5 55%, #f7d7d7 100%) !important;
	}
	#overlay .content h1 { color:#fff !important; letter-spacing:2px; }
	#overlay .content h3 { color:#fdf5f5 !important; }
	#overlay .content p  { color:rgba(255,255,255,.85) !important; }
	#overlay .btn-primary {
		background:transparent !important; border:1px solid #fff !important;
		color:#fff !important; letter-spacing:3px; text-transform:uppercase;
		font-size:.8rem; padding:.7rem 2rem; border-radius:0;
	}
	#overlay .btn-primary:hover { background:#fff !important; color:#8b6b6b !important; }

	/* Header */
	#fh5co-header { background:linear-gradient(180deg,#fdf5f5 0%,#f7d7d7 100%) !important; }
	#fh5co-header h2 { color:#d4a5a5 !important; letter-spacing:4px; }
	#fh5co-header h1 { color:#8b6b6b !important; }
	#fh5co-header p[style*="bf9b73"] { color:#d4a5a5 !important; }
	#fh5co-header .btn-primary { background:#d4a5a5 !important; border-color:#d4a5a5 !important; border-radius:0; letter-spacing:2px; }
	#fh5co-header .btn-info    { background:#f7d7d7 !important; border-color:#f7d7d7 !important; color:#8b6b6b !important; }
	#fh5co-header a[style*="bf9b73"] { background:#d4a5a5 !important; }

	/* Countdown */
	.simply-countdown > .simply-section { background:#d4a5a5 !important; border-radius:6px; }
	.simply-countdown > .simply-section .simply-amount { color:#fff !important; }
	.simply-countdown > .simply-section .simply-word   { color:rgba(255,255,255,.75) !important; }

	/* Couple section */
	#fh5co-couple { background:#fdf5f5 !important; }
	#fh5co-couple h2 { color:#d4a5a5 !important; }
	#fh5co-couple h3 { color:#8b6b6b !important; }
	#fh5co-couple .desc-groom h3,
	#fh5co-couple .desc-bride h3 { color:#d4a5a5 !important; }
	#fh5co-couple .desc-groom p span[style*="bf9b73"],
	#fh5co-couple .desc-bride  p span[style*="bf9b73"] { color:#d4a5a5 !important; }
	#fh5co-couple .icon-heart2 { color:#d4a5a5 !important; }
	#fh5co-couple .fh5co-social-icons a { color:#d4a5a5 !important; }

	/* Event section */
	#fh5co-event { background:#8b6b6b !important; }
	#fh5co-event h2, #fh5co-event h3 { color:#fdf5f5 !important; }
	#fh5co-event .event-wrap {
		background:rgba(255,255,255,.08) !important;
		border:1px solid rgba(247,215,215,.3) !important;
		border-radius:8px;
	}
	#fh5co-event .event-wrap h3 { color:#f7d7d7 !important; }
	#fh5co-event .event-col span { color:#fdf5f5 !important; }
	#fh5co-event .icon-clock, #fh5co-event .icon-calendar { color:#f7d7d7 !important; }
	#fh5co-event .btn-primary { background:#d4a5a5 !important; border-color:#d4a5a5 !important; border-radius:0; }

	/* Gallery */
	#fh5co-gallery { background:#fdf5f5 !important; }
	#fh5co-gallery h2 { color:#d4a5a5 !important; }
	#fh5co-gallery h3 { color:#d4a5a5 !important; }

	/* Quote / ayat */
	#fh5co-ayat { background:linear-gradient(135deg,#d4a5a5 0%,#8b6b6b 100%) !important; }
	#fh5co-ayat .ayat-content { color:#fff !important; font-family:'Merriweather',serif !important; font-style:italic; }

	/* Health protocol */
	#fh5co-health-protocol { background:#fdf5f5 !important; }
	#fh5co-health-protocol h2 { color:#d4a5a5 !important; }
	#fh5co-health-protocol h3 { color:#8b6b6b !important; font-size:1rem !important; }
	#fh5co-health-protocol p[style*="bf9b73"] { color:#d4a5a5 !important; }

	/* Wishes */
	#fh5co-testimonial { background:#fdf5f5 !important; }
	#fh5co-testimonial h2 { color:#d4a5a5 !important; }
	#fh5co-testimonial span[style*="bf9b73"] { color:#d4a5a5 !important; }
	#fh5co-testimonial .btn-primary { background:#d4a5a5 !important; border-color:#d4a5a5 !important; border-radius:0; }
	#fh5co-testimonial .form-control:focus { border-color:#d4a5a5 !important; box-shadow:0 0 0 .2rem rgba(212,165,165,.15) !important; }

	/* Footer */
	#fh5co-footer { background:#8b6b6b !important; }
	#fh5co-footer h1 { color:#fdf5f5 !important; }
	#fh5co-footer h3 { color:#f7d7d7 !important; }
	#fh5co-footer p  { color:rgba(255,255,255,.7) !important; }
	#fh5co-footer small { color:rgba(255,255,255,.5) !important; }
	#fh5co-footer div[style*="rgba(191"] { background:rgba(212,165,165,.15) !important; border-color:rgba(212,165,165,.35) !important; }
	#fh5co-footer a[style*="bf9b73"] { background:#d4a5a5 !important; }
	#fh5co-footer div[style*="bf9b73"] { color:#f7d7d7 !important; }

	/* Floating button */
	.float .control-center .option-btn { background-color:#d4a5a5 !important; }
