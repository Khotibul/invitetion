...
<head>
	...
	<!-- Navy Blue & Silver Theme Override -->
	<style>
	/* ═══════════════════════════════════════════
	   THE WEDDING — NAVY BLUE & SILVER EDITION
	   Warna utama : #1e3a5f (navy)
	   Aksen       : #8fa8c8 (silver-blue)
	   Latar gelap : #0d1f35
	═══════════════════════════════════════════ */
	...
	.couple-main {
		...
		box-shadow: 0 0 0 6px rgba(30,58,95,.15) !important;
	}
	...
	.footer-couple-photo  { width:100px; height:100px; border-radius:50%; object-fit:cover; border:3px solid #1e3a5f; box-shadow:0 4px 15px rgba(0,0,0,.15); }
	.footer-couple-placeholder { width:100px; height:100px; border-radius:50%; background:#e8eef5; border:3px solid #1e3a5f; display:flex; align-items:center; justify-content:center; color:#1e3a5f; font-size:2.5rem; }
	.footer-couple-sep { font-size:1.8rem; color:#8fa8c8; font-family:'Satisfy',Arial,serif; }

	/* Overlay cover */
	#overlay {
		background: linear-gradient(160deg, #0d1f35 0%, #1e3a5f 55%, #2d5a8e 100%) !important;
	}
	#overlay .content h1 { color:#c8d8e8 !important; letter-spacing:2px; }
	#overlay .content h3 { color:#8fa8c8 !important; }
	#overlay .content p  { color:rgba(200,216,232,.75) !important; }
	#overlay .btn-primary {
		background:transparent !important; border:1px solid #8fa8c8 !important;
		color:#c8d8e8 !important; letter-spacing:3px; text-transform:uppercase;
		font-size:.8rem; padding:.7rem 2rem; border-radius:0;
	}
	#overlay .btn-primary:hover { background:#8fa8c8 !important; color:#0d1f35 !important; }

	/* Header */
	#fh5co-header { background:linear-gradient(180deg,#f0f4f8 0%,#e8eef5 100%) !important; }
	#fh5co-header h2 { color:#1e3a5f !important; letter-spacing:4px; }
	#fh5co-header h1 { color:#0d1f35 !important; }
	#fh5co-header p[style*="bf9b73"] { color:#2d5a8e !important; }
	#fh5co-header .btn-primary { background:#1e3a5f !important; border-color:#1e3a5f !important; border-radius:0; letter-spacing:2px; }
	#fh5co-header .btn-info    { background:#8fa8c8 !important; border-color:#8fa8c8 !important; color:#0d1f35 !important; }
	#fh5co-header a[style*="bf9b73"] { background:#1e3a5f !important; }

	/* Countdown */
	.simply-countdown > .simply-section { background:#1e3a5f !important; border-radius:6px; }
	.simply-countdown > .simply-section .simply-amount { color:#c8d8e8 !important; }
	.simply-countdown > .simply-section .simply-word   { color:rgba(200,216,232,.65) !important; }

	/* Couple section */
	#fh5co-couple { background:#f0f4f8 !important; }
	#fh5co-couple h2 { color:#1e3a5f !important; }
	#fh5co-couple h3 { color:#0d1f35 !important; }
	#fh5co-couple .desc-groom h3,
	#fh5co-couple .desc-bride h3 { color:#1e3a5f !important; }
	#fh5co-couple .desc-groom p span[style*="bf9b73"],
	#fh5co-couple .desc-bride  p span[style*="bf9b73"] { color:#2d5a8e !important; }
	#fh5co-couple .icon-heart2 { color:#1e3a5f !important; }
	#fh5co-couple .fh5co-social-icons a { color:#1e3a5f !important; }

	/* Event section */
	#fh5co-event { background:#0d1f35 !important; }
	#fh5co-event h2, #fh5co-event h3 { color:#c8d8e8 !important; }
	#fh5co-event .event-wrap {
		background:rgba(255,255,255,.05) !important;
		border:1px solid rgba(143,168,200,.25) !important;
		border-radius:8px;
	}
	#fh5co-event .event-wrap h3 { color:#8fa8c8 !important; }
	#fh5co-event .event-col span { color:#c8d8e8 !important; }
	#fh5co-event .icon-clock, #fh5co-event .icon-calendar { color:#8fa8c8 !important; }
	#fh5co-event .btn-primary { background:#1e3a5f !important; border-color:#2d5a8e !important; border-radius:0; }

	/* Gallery */
	#fh5co-gallery { background:#f0f4f8 !important; }
	#fh5co-gallery h2 { color:#1e3a5f !important; }
	#fh5co-gallery h3 { color:#2d5a8e !important; }

	/* Quote / ayat */
	#fh5co-ayat { background:linear-gradient(135deg,#1e3a5f 0%,#0d1f35 100%) !important; }
	#fh5co-ayat .ayat-content { color:#c8d8e8 !important; font-family:'Merriweather',serif !important; font-style:italic; }

	/* Health protocol */
	#fh5co-health-protocol { background:#f0f4f8 !important; }
	#fh5co-health-protocol h2 { color:#1e3a5f !important; }
	#fh5co-health-protocol h3 { color:#0d1f35 !important; font-size:1rem !important; }
	#fh5co-health-protocol p[style*="bf9b73"] { color:#2d5a8e !important; }

	/* Wishes */
	#fh5co-testimonial { background:#f0f4f8 !important; }
	#fh5co-testimonial h2 { color:#1e3a5f !important; }
	#fh5co-testimonial span[style*="bf9b73"] { color:#2d5a8e !important; }
	#fh5co-testimonial .btn-primary { background:#1e3a5f !important; border-color:#1e3a5f !important; border-radius:0; }
	#fh5co-testimonial .form-control:focus { border-color:#1e3a5f !important; box-shadow:0 0 0 .2rem rgba(30,58,95,.15) !important; }

	/* Footer */
	#fh5co-footer { background:#0d1f35 !important; }
	#fh5co-footer h1 { color:#c8d8e8 !important; }
	#fh5co-footer h3 { color:#8fa8c8 !important; }
	#fh5co-footer p  { color:rgba(200,216,232,.6) !important; }
	#fh5co-footer small { color:rgba(200,216,232,.4) !important; }
	#fh5co-footer div[style*="rgba(191"] { background:rgba(30,58,95,.12) !important; border-color:rgba(30,58,95,.3) !important; }
	#fh5co-footer a[style*="bf9b73"] { background:#1e3a5f !important; }
	#fh5co-footer div[style*="bf9b73"] { color:#8fa8c8 !important; }

	/* Floating button */
	.float .control-center .option-btn { background-color:#1e3a5f !important; }
